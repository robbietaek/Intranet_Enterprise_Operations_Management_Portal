 ...
 * Generated at: 2019-12-09 00:43:29 UTC
...
public final class vacationForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tif(vr.startdate.value == \"\"){\r\n");
      out.write("\t\talert(\"시작일을 입력하세요.\");\r\n");
      out.write("\t\tsm.startdate.focus();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}else if(vr.enddate.value == \"\") {\r\n");
      out.write("\t\talert(\"종료일을 입력하세요\");\r\n");
      out.write("\t\tsm.enddate.focus();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\tvr.submit();\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<h2>휴가 신청</h2>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<form class=\"form-pill\" action=\"vacationwrite.do\" name=\"vr\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmethod=\"POST\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"exampleFormControlSelect3\">종류</label> <select\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" name=\"vacationtype\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option>휴가</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option>연차</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option>월차</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option>외출</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option>조퇴</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"exampleFormControlInput3\">시작일</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype=\"date\" class=\"form-control\" name=\"startdate\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"1900-01-01\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"exampleFormControlPassword3\">종료일</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype=\"date\" class=\"form-control\" name=\"enddate\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"1900-01-02\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"text-right mb-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-default\" onclick=\"check()\">신청하기</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-secondary btn-default\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tonclick=\"opener_close()\">닫기</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
