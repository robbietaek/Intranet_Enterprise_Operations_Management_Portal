							...
							<form action="emplistForm.do" name="sf" method="post">
								...
								<div class="input-group">
									...
									<input type="text" name="find" id="search-input"
										class="form-control" placeholder="검색 ex) 2019-12-03" autofocus
								...
								<ul class="pagination border-rounded justify-content-center">
									...
									<c:if test="${pageNum > 1 }">
										<li class="page-item"><a class="page-link"
											href="emplistForm.do?id=${id}&pageNum=${pageNum-1}"
											aria-label="Previous"> <span aria-hidden="true"
												class="mdi mdi-chevron-left"></span> <span class="sr-only">Previous</span>
										</a></li>
									</c:if>
									...
									<c:forEach var="a" begin="${startpage}" end="${endpage}">
										...
										<c:if test="${a!=pageNum}">
											<li class="page-item"><a class="page-link"
												href="emplistForm.do?id=${id}&pageNum=${a}">${a}</a></li>
										</c:if>
									</c:forEach>
									...
									<c:if test="${pageNum < maxpage }">
										<li class="page-item"><a class="page-link"
											href="emplistForm.do?id=${id}&pageNum=${pageNum + 1}" aria-label="Next">
