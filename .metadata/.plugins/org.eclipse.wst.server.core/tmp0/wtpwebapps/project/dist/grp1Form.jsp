				...
				<div class="col-lg-12">
					<div class="card card-default">
						<div class="card-header card-header-border-bottom">
							...
							<input type="button" class="btn btn-primary" onclick="sendto1()" value="전체 쪽지 보내기">
								</c:if>
						...
						<div class="card-body">
							...
							<c:if test="${boardcnt > 0}">
								...
								<tbody>
									<c:forEach var="b" items="${list}">
										<tr>
											<td><a
												href="grp1textForm.do?num=${b.num}&pageNum=${pageNum}">${b.subject}</a></td>
											<td>${b.subtype}</td>
								...
								<ul class="pagination border-rounded justify-content-center">
									...
									<c:if test="${pageNum > 1 }">
										<li class="page-item"><a class="page-link"
											href="grp1Form.do?pageNum=${pageNum-1}" aria-label="Previous">
									...
									<c:if test="${pageNum < maxpage }">
										<li class="page-item"><a class="page-link"
											href="grp1Form.do?pageNum=${pageNum + 1}" aria-label="Next">
							...
							<div class="text-right mb-3">
								<form action="grp1writeForm.do" name="nt"
				...
				<div class="col-lg-6">
					<div class="card card-default">
						...
						<c:if test="${member.position == '이사'||member.position == '부장'||member.position == '차장'||member.position == '과장'}">
							...
							<form action="grp1processwrite.do" method="POST" class="text-right mb-3"
								name="f">
							...
							<form action="grp1processdelete.do" name="f" method="POST"
