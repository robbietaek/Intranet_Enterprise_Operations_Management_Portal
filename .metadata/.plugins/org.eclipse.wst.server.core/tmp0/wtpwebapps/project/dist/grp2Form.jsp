				...
				<div class="col-lg-12">
					<div class="card card-default">
						<div class="card-header card-header-border-bottom">
							...
							<input type="button" class="btn btn-primary" onclick="sendto2()" value="전체 쪽지 보내기">
								</c:if>
						</div>

						<div class="card-body">

							<form action="grp2Form.do" name="sf" method="post">
								...
								<div class="input-group">
									...
									<select name="column">
										...
										<option value="id,content">id+내용</option>
									</select>
									<script>
							...
							<c:if test="${boardcnt > 0}">
								...
								<tbody>
									<c:forEach var="b" items="${list}">
										<tr>
											<td><a
												href="grp2textForm.do?num=${b.num}&pageNum=${pageNum}">${b.subject}</a></td>
											<td>${b.subtype}</td>
								...
								<ul class="pagination border-rounded justify-content-center">
									...
									<c:if test="${pageNum > 1 }">
										<li class="page-item"><a class="page-link"
											href="grp2Form.do?pageNum=${pageNum-1}" aria-label="Previous">
									...
									<c:forEach var="a" begin="${startpage}" end="${endpage}">
										...
										<c:if test="${a!=pageNum}">
											<li class="page-item"><a class="page-link"
												href="grp2Form.do?pageNum=${a}">${a}</a></li>
										</c:if>
									</c:forEach>
									...
									<c:if test="${pageNum < maxpage }">
										<li class="page-item"><a class="page-link"
											href="grp2Form.do?pageNum=${pageNum + 1}" aria-label="Next">
							...
							<div class="text-right mb-3">
								<form action="grp2writeForm.do" name="nt"
				...
				<div class="col-lg-6">
					<div class="card card-default">
						...
						<div class="card-body">
							...
							<form action="grp2processwrite.do" method="POST" class="text-right mb-3"
								name="f">
							...
							<form action="grp2processdelete.do" name="f" method="POST"
