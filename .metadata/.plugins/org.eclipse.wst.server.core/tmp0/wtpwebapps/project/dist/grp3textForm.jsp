							...
							<div class="form-footer pt-4 pt-5 mt-4 border-top text-right">
								<c:if test="${sessionScope.login==b.id}">
									<button type="button" class="btn btn-primary btn-default"
										onclick="location.href ='grp3editForm.do?num=${b.num}&pageNum=${param.pageNum}'">수정하기</button>
									<button type="button" class="btn btn-secondary btn-default"
										onclick="location.href ='grp3delete.do?num=${b.num}&pageNum=${param.pageNum}'">삭제하기</button>
								</c:if>
							</div>
							<div class="col-lg-12">
								<!-- Chats -->
												...
												<div class="media-body">
													<div class="row">
														...
														<c:if test="${sessionScope.login == r.id}">
															<form action="grp3replydelete.do" method="POST" name="dp">
																<div class="col-lg-1">
								...
								<form action="grp3replywrite.do" method="POST" name="rp">
