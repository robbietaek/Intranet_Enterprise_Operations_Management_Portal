				...
				<div class="col-lg-12">
					<div class="card card-default">
						<div class="card-header card-header-border-bottom">
							...
							<input type="button" class="btn btn-primary" onclick="sendto4()" value="전체 쪽지 보내기">
								</c:if>
						</div>
				...
				<div class="col-lg-6">
					<div class="card card-default">
						...
						<div class="card-body">
							...
							<form action="grp4processwrite.do" method="POST" class="text-right mb-3"
								name="f">
							...
							<form action="grp4processdelete.do" name="f" method="POST"
