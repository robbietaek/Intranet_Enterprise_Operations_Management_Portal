		...
		<div class="content">
			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<c:forEach var="a" items="${blist}" begin="0" end="0">
				...
				<div class="col-xl-7">
					<div class="card card-default" data-scroll-height="200">
						...
						<div class="card-body py-0">
							<c:forEach var="v" items="${recvmem}" begin="0" end="0">
								<div class="media d-flex mb-5">
									<div class="media-image align-self-center mr-3 rounded">
										<img class="rounded-circle w-45" src="picture/${v.picture}"
											alt="customer image">
									</div>
									<div class="media-body align-self-center">
										<h6 class="mb-3 text-dark font-weight-medium">${v.name}</h6>
										<p class="d-none d-md-block">${v.dept}의 ${v.name} 직원이
											받았습니다. 축하해주세요!</p>
									</div>
								</div>
							</c:forEach>
