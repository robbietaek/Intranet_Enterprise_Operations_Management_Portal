					...
					<div class="col-lg-12">
						<div class="card card-default">
							...
							<div class="card-body">
								...
								<form action="messageboxForm.do" name="sf" method="post">
									...
									<div class="input-group">
										...
										<select name="column">
											...
											<option value="sendid">아이디</option>
										</select>
										<script>
									...
									<ul class="pagination border-rounded justify-content-center">
										...
										<c:if test="${pageNum > 1 }">
											<li class="page-item"><a class="page-link"
												href="messageboxForm.do?pageNum=${pageNum-1}"
												aria-label="Previous"> <span aria-hidden="true"
													class="mdi mdi-chevron-left"></span> <span class="sr-only">Previous</span>
											</a></li>
										</c:if>
										...
										<c:forEach var="a" begin="${startpage}" end="${endpage}">
											...
											<c:if test="${a!=pageNum}">
												<li class="page-item"><a class="page-link"
													href="messageboxForm.do?pageNum=${a}">${a}</a></li>
											</c:if>
										</c:forEach>
