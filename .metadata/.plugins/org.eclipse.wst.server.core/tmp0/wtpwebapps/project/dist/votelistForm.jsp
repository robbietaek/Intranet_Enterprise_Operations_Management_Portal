				...
				<div class="col-xl-5">
					...
					<div class="card card-table-border-none" data-scroll-height="580">
						...
						<div class="card-body pt-0">
							<form action="voteinsert.do" name="vi" method="POST">
								<table class="table ">
									<tbody>
													...
													<div class="media">
														<div class="media-image mr-3 rounded-circle">
															<img class="rounded-circle w-45"
																src="picture/${m.picture}" alt="customer image"></a>
														</div>
														<div class="media-body align-self-center">
															<h6 class="mt-0 text-dark font-weight-medium">${m.dept}</h6>
															</a> <small>${m.name}</small>
														</div>
													</div>
												</td>
												<td><label class="control control-radio radio-success">투표하기
														<input type="radio" name="votedid" value = "${m.id}" />
								...
								<div class="d-flex justify-content-end mt-5">
									<button type="submit" class="btn btn-primary mb-2 btn-pill">선정하기</button>
								</div>
							</form>
