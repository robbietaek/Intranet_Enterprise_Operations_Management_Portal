...
SELECT * FROM board WHERE boardtype = 7 and recvid = "${sessionScope.login}" order by num desc
</sql:query>
<sql:query var="ck" dataSource="${conn}">
select * from board where boardtype = 8 and id = "${sessionScope.login}" order by grp desc
</sql:query>
...
<script type="text/javascript">
	...
	function decoratormessage(num) {
		var op = "width=600, height=600, left = 600,top=200";
		open("messagetextForm.do?num="+num, "", op);
	}
						...
						<ul class="nav navbar-nav">
							<li class="dropdown notifications-menu">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									...
									<li><c:forEach var="m" items="${ms.rows}" begin="0"
											end="5">
											<a href="" onclick="decoratormessage(${m.num})"> <i
												class="mdi mdi-account-plus"></i> ${m.id } <span
												class=" font-size-12 d-inline-block float-right"> <i
													class="mdi mdi-clock-outline"></i> ${m.regdate }
											</span>
											</a>
										</c:forEach></li>
								</ul>
							...
							<li class="dropdown notifications-menu">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li class="dropdown-header">체크리스트</li>
									<li><c:forEach var="c" items="${ck.rows}" begin="0"
											end="5">
											<a> <i class="mdi mdi-pencil-box"></i> ${c.content }
											</a>
										</c:forEach></li>
								</ul>
							</li>
							...
							<li class="dropdown user-menu">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									...
									<li><a href="" onclick="leavework()"> <i
											class="mdi mdi-door"></i> 퇴근하기
									</a></li>
