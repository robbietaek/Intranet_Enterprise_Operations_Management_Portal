...
<script type="text/javascript">
	...
	function sendmessagecheck() {
		if(sm.recvid.value == ""){
			...
			sm.recvid.focus();
			return false;
		}else if(sm.subject.value == "") {
			alert("제목을 입력하세요");
			sm.subject.focus();
			return false;
		}else if (sm.content.value == "") {
			alert("내용을 입력하세요");
			sm.content.focus();
			return false;
		}else{
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="card card-default">
						...
						<div class="card-body">
							<form action = "sendmessage.do" name = "sm" method = "POST">
								<div class="form-group">
									<label for="exampleFormControlInput1">받을 사원번호를 입력하세요.</label> <input
										type="text" class="form-control" name = "recvid"
										placeholder="ex)151534..">
								</div>
								<div class="form-group">
								...
								<div class="form-footer pt-4 pt-5 mt-4 border-top">
									<button type="button" class="btn btn-primary btn-default" onclick="sendmessagecheck()">보내기</button>
