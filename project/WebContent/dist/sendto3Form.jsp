...
<script type="text/javascript">
	...
	function sendto3check() {
		if (st3.subject.value == "") {
			alert("제목을 입력하세요");
			st3.subject.focus();
			return false;
		}else if (st3.content.value == "") {
			alert("내용을 입력하세요");
			st3.content.focus();
			return false;
		}else{
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="card card-default">
							...
							<div class="card-body">
								<form action = "sendto3.do" name = "st3" method = "POST">
									...
									<div class="form-footer pt-4 pt-5 mt-4 border-top">
										<button type="button" class="btn btn-primary btn-default" onclick="sendto3check()">보내기</button>
